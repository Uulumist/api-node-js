...
5. GET: получить пользователя по несуществующему ID
6. GET: неверный формат ID
7. DELETE: удалить пользователя по существующему ID
8. DELETE: удалить пользователя по несуществующему ID
